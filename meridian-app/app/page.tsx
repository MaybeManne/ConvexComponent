...
// Convex FilterApi doesn't always resolve in strict TS — safe cast
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const ariaApi = (api as any).aria;
...
export default function AriaChat() {
  ...
  const createConversation = useMutation(ariaApi.createConversation);
  const sendMessage = useMutation(ariaApi.sendMessage);
  const messages: Doc<"ariaMessages">[] | undefined = useQuery(
    ariaApi.getMessages,
    ...
    >
      ...
      >
        ...
        {!messages || messages.length === 0 ? (
          ...
          >
            {messages.map((msg: Doc<"ariaMessages">) => (
              <div
                key={msg._id}
                className="msg-enter"
                style={{
